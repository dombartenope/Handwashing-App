var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			span = element("span");
    			t = text("%");
    			attr(span, "class", "sr-only svelte-c2s0xp");
    			set_style(span, "width", /*progress*/ ctx[0] + "%");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div0, "class", "progress-bar svelte-c2s0xp");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-c2s0xp");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const progressbar = new ProgressBar({
    			props: { progress: /*inverseSeconds*/ ctx[2] }
    		});
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*inverseSeconds*/ 4) progressbar_changes.progress = /*inverseSeconds*/ ctx[2];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(2, inverseSeconds = (totalSeconds - secondsLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondsLeft, isRunning, inverseSeconds, handleClick];
    }
  ...
  <a href="https://freesound.org/people/metrostock99/sounds/345086/">
    Sound Source
    			...
    			attr(h1, "class", "svelte-y2uzf8");
    			attr(h3, "class", "svelte-y2uzf8");
    		},
    		m(target, anchor) {
